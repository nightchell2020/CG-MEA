...
def train_multistep_IL(pre_model, new_model, loader, preprocess, optimizer, scheduler, amp_scaler, config, steps):
    new_model.train()
        ...
        for sample_batched in loader:
            ...
            if config.get("mixed_precision", False):
                ...
                if "clip_grad_norm" in config:
                    ...
                    torch.nn.utils.clip_grad_norm_(new_model.parameters(), config["clip_grad_norm"])
